...
class _Config:
    ...
    def __init__(self, num_gpus=1):
        ...
        self.data_dir = "./dataset/svgs_tensor/"                 #  "./dataset/svgs_tensor_processed/" "./dataset/icons_tensor/"
        self.meta_filepath = "./dataset/svgs_meta.csv"           #  "./dataset/svgs_meta_processed.csv"  "./dataset/icons_meta.csv"
